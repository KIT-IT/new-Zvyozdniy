  ...
  return (
    <div className="ltl-discont-block">
      <div className="ltl-discont-block__toggle" onClick={() => setDropedText(!dropedText)}>
        ...
        <CSSTransition nodeRef={nodeRef} in={dropedText} timeout={1000} classNames="droped-text" unmountOnExit>
          <div ref={nodeRef} className="ltl-discont-block__dropped-content">
