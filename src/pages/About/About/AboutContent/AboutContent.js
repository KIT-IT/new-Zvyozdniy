                ...
                <div className="about-unification _block">
                    ...
                    <div className="about-unification-content">
                        <div className="about-unification-content__info">
                            <p className="about-unification-content__info_text">На территории поселения Краснопахорское в городе Москве, путем слияния нескольких юридических лиц и передачи в безвозмездное пользование имущество, образовался культурный комплекс – Муниципальное бюджетное учреждение культуры «Дом культуры «Звёздный», в состав которого входят: обособленное структурное подразделение «Дом культуры «Юбилейный», обособленное структурное подразделение «Краснопахорская библиотечная система» и Многофункциональный визит – центр.</p>
                        </div>
